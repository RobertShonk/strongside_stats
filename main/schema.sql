...
CREATE TABLE metadata (
    ...
    endOfGameResult TEXT NOT NULL, -- info
...
CREATE TABLE participant (
    ...
    minor_rune_defense INTEGER NOT NULL,
    minor_rune_flex INTEGER NOT NULL,
    minor_rune_offense INTEGER NOT NULL,
    primary_main_rune INTEGER NOT NULL,
    primary_rune1 INTEGER NOT NULL,
    primary_rune2 INTEGER NOT NULL,
    primary_rune3 INTEGER NOT NULL,
    secondary_main_rune INTEGER NOT NULL,
